...
<div style="width: 1000px; margin-top: 5%; margin-left: 23.5%;" class="container">
    <div style="background-image: linear-gradient(to bottom right, #F1F1F1, #33BBAD);" class="card">
        ...
        <div class="wrapper row">
          ...
          <div class="details col-md-6">
           <p></p>
            ...
            <h5 class="sizes">Date:<span style="margin-left: 10px;">{{ \Carbon\Carbon::parse($details->date)->format('d/m/Y')}}</span></h5>
...
<div style="margin-left: 46%;" class="row bootstrap snippets">
